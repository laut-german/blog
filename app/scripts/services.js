(function(){
 ...
 function Comment($resource,BaseUrl){
 	return $resource(BaseUrl.substring(0,BaseUrl.length-1) + '/comments/:commentId', {commentId: '@_id'});
 }

 function User($resource,BaseUrl){
 	return $resource(BaseUrl.substring(0,BaseUrl.length-1) + '/users/:userId', {userId: '@_id'});
 }
